      ...
      <header className="pro-navbar">
        ...
        <div className="pro-right">
          ...
          <div className="vc-icon-group">
            <button className="vc-icon-btn btn-vc-dashboard" title="Back" aria-label="Back" data-tip="Back" onClick={() => navigate("/vehicle-config")}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M19 12H5M12 19l-7-7 7-7" />
              </svg>
            </button>
            <button className="vc-icon-btn btn-vc-modules" title="Dashboard" aria-label="Dashboard" data-tip="Dashboard" onClick={() => navigate("/dashboard")}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M3 12L12 3l9 9" /><path d="M9 21V12h6v9" />
              </svg>
            </button>
            <button className="vc-icon-btn btn-vc-logout" title="Logout" aria-label="Logout" data-tip="Logout" onClick={handleLogout}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      paginated.map((c, idx) => {
                        ...
                        return (
                          <tr key={c.id} className={editingId === c.id ? "cp-row-editing" : ""}>
                            <td className="cmtd-sn" data-label="#">{(currentPage - 1) * PAGE_SIZE + idx + 1}</td>
                            <td className="cmtd-model" data-label="Model">
                              <span className="cp-model-badge">{modelName}</span>
                            </td>
                            <td className="cmtd-variant" data-label="Variant">
                              <span className="cp-variant-badge">{variantName}</span>
                            </td>
                            <td className="cmtd-colour" data-label="Colour">
                            ...
                            <td className="cmtd-act" data-label="Actions">
                              <div className="cp-row-acts">
