    ...
    <div className="ve-page">
      ...
      <main className="ve-main">
        ...
        <div className="ve-form-wrapper">
          {successMessage && <div className="ve-alert success">{successMessage}</div>}
          {errorMessage && <div className="ve-alert error">{errorMessage}</div>}
          ...
          <div className="ve-form-nav">
            <button className="ve-btn-ghost" onClick={() => navigate("/dashboard")}>Cancel</button>
            <button className="ve-btn-primary" onClick={handleSubmit}>Submit Request</button>
          </div>
        </div>
      </main>
    </div>
